...
<section className='pl-[10rem] flex flex-wrap'>
    ...
    <div className='mr-[4rem] mt-[5rem]'>
        ...
        className='container w-[40rem]'>
            ...
            disabled={isLoading}
            type='submit'
            className='bg-pink-500 text-white py-4 px-4 rounded cursor-pointer my-[1rem]'
            >
    ...
    <img src="https://images.unsplash.com/photo-1576502200916-3808e07386a5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWd26Hx86GVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2065&q=80" 
    alt="" 
    className='h-[65rem] w-[59%] x2:bloch md:hidden sm:hidden rounded-2g' />
